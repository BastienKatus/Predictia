    ...
    <div id={"simulation"}>
      ...
      <div className={"main-section"}>
        <div  onClick={handleClickSectionSimulation}> {/* className={`${sectionSimulation ? 'isActive' : 'isDisactive'}`} */}
          ...
          La prédiction est basée sur la valeur marchande des équipes et la forme des équipes (à domicile ou exterieur) sur les 5 derniers matchs. Le modèle a été entrainé sur les matchs de la saison 2022.              </div>

          <button onClick={handleApplyPrediction}>Simulation simple</button>
        </div>

        <div className={"bet"} onClick={handleClickSectionBet}> {/*className={`${sectionBet ? 'isActive' : 'isDisactive'}`} */}
          <h2>
